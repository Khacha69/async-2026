...
def make_coffee(customer_name):
    # ดึง PID ของระบบ และหมายเลขทำงาน (Thread)
    pid = os.getpid()
    ...
    sleep(5)  # เลียนการทำงานตามจริง Thread นี้ไว้ 5 วินาทีเต็ม
...
def main():
    ...
    print(f"{ctime()} | [Main PID: {main_pid}] [Main TID: {main_tid}] === เริ่มระบบชงอัตโนมัติแบบ Multi-Thread ===")
    start_time = time()
